...
module folo_zeropad2d_cl_array_array_ap_fixed_16_6_5_3_0_4u_config33_Pipeline_CopyMain (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1_grp1 = ((layer33_out_full_n == 1'b0) | (layer29_cpy1_empty_n == 1'b0));
end
...
assign layer33_out_din = layer29_cpy1_dout;

endmodule //folo_zeropad2d_cl_array_array_ap_fixed_16_6_5_3_0_4u_config33_Pipeline_CopyMain
