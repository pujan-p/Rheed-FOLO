...
architecture rtl of folo_fifo_w80_d1_S is
...
------------------------Component----------------------
    component folo_fifo_w80_d1_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 80;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 1);
...
begin
----------------------- Instantiation -----------------------
    U_folo_fifo_w80_d1_S_ShiftReg : folo_fifo_w80_d1_S_ShiftReg
    generic map (
...
entity folo_fifo_w80_d1_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 80;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 1);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end folo_fifo_w80_d1_S_ShiftReg;

architecture rtl of folo_fifo_w80_d1_S_ShiftReg is
