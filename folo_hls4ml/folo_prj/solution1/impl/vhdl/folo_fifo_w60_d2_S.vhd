...
architecture rtl of folo_fifo_w60_d2_S is
...
------------------------Component----------------------
    component folo_fifo_w60_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 60;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_folo_fifo_w60_d2_S_ShiftReg : folo_fifo_w60_d2_S_ShiftReg
    generic map (
...
entity folo_fifo_w60_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 60;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end folo_fifo_w60_d2_S_ShiftReg;

architecture rtl of folo_fifo_w60_d2_S_ShiftReg is
