...
entity folo_zeropad2d_cl_array_array_ap_fixed_16_6_5_3_0_4u_config32_Pipeline_CopyMain is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of folo_zeropad2d_cl_array_array_ap_fixed_16_6_5_3_0_4u_config32_Pipeline_CopyMain is 
...
attribute shreg_extract : string;
    ...
    signal j_6_fu_68_p2 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    ap_sig_allocacmp_j_5_assign_proc : process(ap_CS_fsm_pp0_stage0, j_fu_36, ap_loop_init, ap_block_pp0_stage0)
    begin
        if (((ap_loop_init = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            ap_sig_allocacmp_j_5 <= ap_const_lv8_0;
        else 
            ap_sig_allocacmp_j_5 <= j_fu_36;
        end if; 
    end process;

    icmp_ln65_fu_62_p2 <= "1" when (ap_sig_allocacmp_j_5 = ap_const_lv8_80) else "0";
    j_6_fu_68_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_j_5) + unsigned(ap_const_lv8_1));
