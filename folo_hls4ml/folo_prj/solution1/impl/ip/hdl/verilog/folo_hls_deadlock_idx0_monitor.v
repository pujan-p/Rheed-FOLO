...
module folo_hls_deadlock_idx0_monitor ( // for module folo_folo_inst
    ...
    input wire [37:0] inst_idle_sigs,
    input wire [33:0] inst_block_sigs,
    output wire block
);
...
wire idx1_block;
wire idx3_block;
wire [33:0] process_idle_vec;
wire [33:0] process_chan_block_vec;
wire [33:0] process_axis_block_vec;
