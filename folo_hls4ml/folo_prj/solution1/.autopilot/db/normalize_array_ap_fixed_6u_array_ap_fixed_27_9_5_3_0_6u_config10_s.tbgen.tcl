set moduleName normalize_array_ap_fixed_6u_array_ap_fixed_27_9_5_3_0_6u_config10_s
set isTopModule 0
...
set cdfgNum 72
set C_modelName {normalize<array<ap_fixed,6u>,array<ap_fixed<27,9,5,3,0>,6u>,config10>}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ layer9_out int 60 regular {fifo 0 volatile }  }
	{ layer10_out int 162 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "layer9_out", "interface" : "fifo", "bitwidth" : 60, "direction" : "READONLY"} , 
 	{ "Name" : "layer10_out", "interface" : "fifo", "bitwidth" : 162, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer10_out_din sc_out sc_lv 162 signal 1 } 
	...
	{ layer9_out_dout sc_in sc_lv 60 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer10_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":162, "type": "signal", "bundle":{"name": "layer10_out", "role": "din" }} , 
 	...
 	{ "name": "layer9_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":60, "type": "signal", "bundle":{"name": "layer9_out", "role": "dout" }} , 
...
set ArgLastReadFirstWriteLatency {
	normalize_array_ap_fixed_6u_array_ap_fixed_27_9_5_3_0_6u_config10_s {
...
set Spec2ImplPortList { 
	layer9_out { ap_fifo {  { layer9_out_dout fifo_data_out 0 60 }  { layer9_out_empty_n fifo_status_empty 0 1 }  { layer9_out_read fifo_data_in 1 1 }  { layer9_out_num_data_valid fifo_update 0 2 }  { layer9_out_fifo_cap fifo_data 0 2 } } }
	layer10_out { ap_fifo {  { layer10_out_din fifo_data_out 1 162 }  { layer10_out_full_n fifo_status_empty 0 1 }  { layer10_out_write fifo_data_in 1 1 }  { layer10_out_num_data_valid fifo_update 0 2 }  { layer10_out_fifo_cap fifo_data 0 2 } } }
}
