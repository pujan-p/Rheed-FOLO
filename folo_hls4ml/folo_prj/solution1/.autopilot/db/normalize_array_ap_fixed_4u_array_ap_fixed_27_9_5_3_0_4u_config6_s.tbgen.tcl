set moduleName normalize_array_ap_fixed_4u_array_ap_fixed_27_9_5_3_0_4u_config6_s
set isTopModule 0
...
set cdfgNum 72
set C_modelName {normalize<array<ap_fixed,4u>,array<ap_fixed<27,9,5,3,0>,4u>,config6>}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ layer5_out int 40 regular {fifo 0 volatile }  }
	{ layer6_out int 108 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "layer5_out", "interface" : "fifo", "bitwidth" : 40, "direction" : "READONLY"} , 
 	{ "Name" : "layer6_out", "interface" : "fifo", "bitwidth" : 108, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer6_out_din sc_out sc_lv 108 signal 1 } 
	...
	{ layer5_out_dout sc_in sc_lv 40 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer6_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":108, "type": "signal", "bundle":{"name": "layer6_out", "role": "din" }} , 
 	...
 	{ "name": "layer5_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":40, "type": "signal", "bundle":{"name": "layer5_out", "role": "dout" }} , 
...
set ArgLastReadFirstWriteLatency {
	normalize_array_ap_fixed_4u_array_ap_fixed_27_9_5_3_0_4u_config6_s {
...
set PerformanceInfo {[
	...
	, {"Name" : "Interval", "Min" : "49152", "Max" : "49152"}
]}
...
set Spec2ImplPortList { 
	layer5_out { ap_fifo {  { layer5_out_dout fifo_data_out 0 40 }  { layer5_out_empty_n fifo_status_empty 0 1 }  { layer5_out_read fifo_data_in 1 1 }  { layer5_out_num_data_valid fifo_update 0 2 }  { layer5_out_fifo_cap fifo_data 0 2 } } }
	layer6_out { ap_fifo {  { layer6_out_din fifo_data_out 1 108 }  { layer6_out_full_n fifo_status_empty 0 1 }  { layer6_out_write fifo_data_in 1 1 }  { layer6_out_num_data_valid fifo_update 0 2 }  { layer6_out_fifo_cap fifo_data 0 2 } } }
}
