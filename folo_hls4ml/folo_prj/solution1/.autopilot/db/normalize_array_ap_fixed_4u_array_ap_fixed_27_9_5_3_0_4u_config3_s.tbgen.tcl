set moduleName normalize_array_ap_fixed_4u_array_ap_fixed_27_9_5_3_0_4u_config3_s
set isTopModule 0
...
set cdfgNum 72
set C_modelName {normalize<array<ap_fixed,4u>,array<ap_fixed<27,9,5,3,0>,4u>,config3>}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ layer2_out int 40 regular {fifo 0 volatile }  }
	{ layer3_out int 108 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "layer2_out", "interface" : "fifo", "bitwidth" : 40, "direction" : "READONLY"} , 
 	{ "Name" : "layer3_out", "interface" : "fifo", "bitwidth" : 108, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer3_out_din sc_out sc_lv 108 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer3_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":108, "type": "signal", "bundle":{"name": "layer3_out", "role": "din" }} , 
...
set ArgLastReadFirstWriteLatency {
	normalize_array_ap_fixed_4u_array_ap_fixed_27_9_5_3_0_4u_config3_s {
...
set Spec2ImplPortList { 
	layer2_out { ap_fifo {  { layer2_out_dout fifo_data_out 0 40 }  { layer2_out_empty_n fifo_status_empty 0 1 }  { layer2_out_read fifo_data_in 1 1 }  { layer2_out_num_data_valid fifo_update 0 2 }  { layer2_out_fifo_cap fifo_data 0 2 } } }
	layer3_out { ap_fifo {  { layer3_out_din fifo_data_out 1 108 }  { layer3_out_full_n fifo_status_empty 0 1 }  { layer3_out_write fifo_data_in 1 1 }  { layer3_out_num_data_valid fifo_update 0 2 }  { layer3_out_fifo_cap fifo_data 0 2 } } }
}
