...
set C_modelArgList {
	{ layer29_cpy2 int 128 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "layer29_cpy2", "interface" : "fifo", "bitwidth" : 128, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ layer29_cpy2_dout sc_in sc_lv 128 signal 0 } 
	...
	{ layer20_out_dout sc_in sc_lv 128 signal 1 } 
	{ layer20_out_empty_n sc_in sc_logic 1 signal 1 } 
	{ layer20_out_read sc_out sc_logic 1 signal 1 } 
	{ layer20_out_num_data_valid sc_in sc_lv 3 signal 1 } 
	{ layer20_out_fifo_cap sc_in sc_lv 3 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer29_cpy2_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "layer29_cpy2", "role": "dout" }} , 
 	...
 	{ "name": "layer20_out_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "layer20_out", "role": "num_data_valid" }} , 
 	{ "name": "layer20_out_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "layer20_out", "role": "fifo_cap" }} , 
...
set Spec2ImplPortList { 
	layer29_cpy2 { ap_fifo {  { layer29_cpy2_dout fifo_data_out 0 128 }  { layer29_cpy2_empty_n fifo_status_empty 0 1 }  { layer29_cpy2_read fifo_data_in 1 1 }  { layer29_cpy2_num_data_valid fifo_update 0 7 }  { layer29_cpy2_fifo_cap fifo_data 0 7 } } }
	layer20_out { ap_fifo {  { layer20_out_dout fifo_data_out 0 128 }  { layer20_out_empty_n fifo_status_empty 0 1 }  { layer20_out_read fifo_data_in 1 1 }  { layer20_out_num_data_valid fifo_update 0 3 }  { layer20_out_fifo_cap fifo_data 0 3 } } }
