set moduleName normalize_array_ap_fixed_4u_array_ap_fixed_12_6_5_3_0_4u_config3_s
set isTopModule 0
...
set C_modelName {normalize<array<ap_fixed,4u>,array<ap_fixed<12,6,5,3,0>,4u>,config3>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer2_out int 48 regular {fifo 0 volatile }  }
	{ layer3_out int 48 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "layer2_out", "interface" : "fifo", "bitwidth" : 48, "direction" : "READONLY"} , 
 	{ "Name" : "layer3_out", "interface" : "fifo", "bitwidth" : 48, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer3_out_din sc_out sc_lv 48 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer3_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":48, "type": "signal", "bundle":{"name": "layer3_out", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_12s_11ns_18_1_1_U39", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_12s_12ns_18_1_1_U40", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_12s_11ns_18_1_1_U41", "Parent" : "0"},
...
set Spec2ImplPortList { 
	layer2_out { ap_fifo {  { layer2_out_dout fifo_data_in 0 48 }  { layer2_out_num_data_valid fifo_status_num_data_valid 0 15 }  { layer2_out_fifo_cap fifo_update 0 15 }  { layer2_out_empty_n fifo_status 0 1 }  { layer2_out_read fifo_port_we 1 1 } } }
	layer3_out { ap_fifo {  { layer3_out_din fifo_data_in 1 48 }  { layer3_out_num_data_valid fifo_status_num_data_valid 0 15 }  { layer3_out_fifo_cap fifo_update 0 15 }  { layer3_out_full_n fifo_status 0 1 }  { layer3_out_write fifo_port_we 1 1 } } }
}
