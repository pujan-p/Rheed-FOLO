set moduleName add_array_array_ap_fixed_8u_array_ap_fixed_28_10_5_3_0_8u_config21_s
set isTopModule 0
...
set cdfgNum 72
set C_modelName {add<array,array<ap_fixed,8u>,array<ap_fixed<28,10,5,3,0>,8u>,config21>}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ layer29_cpy2 int 80 regular {fifo 0 volatile }  }
	{ layer20_out int 216 regular {fifo 0 volatile }  }
	{ layer21_out int 224 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "layer29_cpy2", "interface" : "fifo", "bitwidth" : 80, "direction" : "READONLY"} , 
 	{ "Name" : "layer20_out", "interface" : "fifo", "bitwidth" : 216, "direction" : "READONLY"} , 
 	{ "Name" : "layer21_out", "interface" : "fifo", "bitwidth" : 224, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer29_cpy2_dout sc_in sc_lv 80 signal 0 } 
	{ layer29_cpy2_empty_n sc_in sc_logic 1 signal 0 } 
	{ layer29_cpy2_read sc_out sc_logic 1 signal 0 } 
	{ layer29_cpy2_num_data_valid sc_in sc_lv 7 signal 0 } 
	{ layer29_cpy2_fifo_cap sc_in sc_lv 7 signal 0 } 
	{ layer20_out_dout sc_in sc_lv 216 signal 1 } 
	...
	{ layer21_out_din sc_out sc_lv 224 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer29_cpy2_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":80, "type": "signal", "bundle":{"name": "layer29_cpy2", "role": "dout" }} , 
 	...
 	{ "name": "layer20_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":216, "type": "signal", "bundle":{"name": "layer20_out", "role": "dout" }} , 
 	...
 	{ "name": "layer21_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":224, "type": "signal", "bundle":{"name": "layer21_out", "role": "din" }} , 
...
set ArgLastReadFirstWriteLatency {
	add_array_array_ap_fixed_8u_array_ap_fixed_28_10_5_3_0_8u_config21_s {
...
set Spec2ImplPortList { 
	layer29_cpy2 { ap_fifo {  { layer29_cpy2_dout fifo_data_out 0 80 }  { layer29_cpy2_empty_n fifo_status_empty 0 1 }  { layer29_cpy2_read fifo_data_in 1 1 }  { layer29_cpy2_num_data_valid fifo_update 0 7 }  { layer29_cpy2_fifo_cap fifo_data 0 7 } } }
	layer20_out { ap_fifo {  { layer20_out_dout fifo_data_out 0 216 }  { layer20_out_empty_n fifo_status_empty 0 1 }  { layer20_out_read fifo_data_in 1 1 }  { layer20_out_num_data_valid fifo_update 0 2 }  { layer20_out_fifo_cap fifo_data 0 2 } } }
	layer21_out { ap_fifo {  { layer21_out_din fifo_data_out 1 224 }  { layer21_out_full_n fifo_status_empty 0 1 }  { layer21_out_write fifo_data_in 1 1 }  { layer21_out_num_data_valid fifo_update 0 32 }  { layer21_out_fifo_cap fifo_data 0 32 } } }
}
