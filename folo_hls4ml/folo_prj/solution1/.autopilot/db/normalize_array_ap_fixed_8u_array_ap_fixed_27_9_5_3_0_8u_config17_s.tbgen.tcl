set moduleName normalize_array_ap_fixed_8u_array_ap_fixed_27_9_5_3_0_8u_config17_s
set isTopModule 0
...
set cdfgNum 72
set C_modelName {normalize<array<ap_fixed,8u>,array<ap_fixed<27,9,5,3,0>,8u>,config17>}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ layer16_out int 80 regular {fifo 0 volatile }  }
	{ layer17_out int 216 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "layer16_out", "interface" : "fifo", "bitwidth" : 80, "direction" : "READONLY"} , 
 	{ "Name" : "layer17_out", "interface" : "fifo", "bitwidth" : 216, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer17_out_din sc_out sc_lv 216 signal 1 } 
	...
	{ layer16_out_dout sc_in sc_lv 80 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer17_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":216, "type": "signal", "bundle":{"name": "layer17_out", "role": "din" }} , 
 	...
 	{ "name": "layer16_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":80, "type": "signal", "bundle":{"name": "layer16_out", "role": "dout" }} , 
...
set ArgLastReadFirstWriteLatency {
	normalize_array_ap_fixed_8u_array_ap_fixed_27_9_5_3_0_8u_config17_s {
...
set Spec2ImplPortList { 
	layer16_out { ap_fifo {  { layer16_out_dout fifo_data_out 0 80 }  { layer16_out_empty_n fifo_status_empty 0 1 }  { layer16_out_read fifo_data_in 1 1 }  { layer16_out_num_data_valid fifo_update 0 2 }  { layer16_out_fifo_cap fifo_data 0 2 } } }
	layer17_out { ap_fifo {  { layer17_out_din fifo_data_out 1 216 }  { layer17_out_full_n fifo_status_empty 0 1 }  { layer17_out_write fifo_data_in 1 1 }  { layer17_out_num_data_valid fifo_update 0 2 }  { layer17_out_fifo_cap fifo_data 0 2 } } }
}
