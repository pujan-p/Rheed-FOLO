set moduleName conv_2d_cl_array_ap_fixed_4u_array_ap_fixed_16_6_5_3_0_6u_config9_s
set isTopModule 0
...
set cdfgNum 70
set C_modelName {conv_2d_cl<array<ap_fixed,4u>,array<ap_fixed<16,6,5,3,0>,6u>,config9>}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ layer32_out int 64 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "layer32_out", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ layer32_out_dout sc_in sc_lv 64 signal 0 } 
	{ layer32_out_empty_n sc_in sc_logic 1 signal 0 } 
	{ layer32_out_read sc_out sc_logic 1 signal 0 } 
	{ layer32_out_num_data_valid sc_in sc_lv 9 signal 0 } 
	{ layer32_out_fifo_cap sc_in sc_lv 9 signal 0 } 
	{ layer9_out_din sc_out sc_lv 96 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer32_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "layer32_out", "role": "dout" }} , 
 	...
 	{ "name": "layer32_out_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "layer32_out", "role": "num_data_valid" }} , 
 	{ "name": "layer32_out_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "layer32_out", "role": "fifo_cap" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "99849", "Max" : "99849"}
	, {"Name" : "Interval", "Min" : "99846", "Max" : "99846"}
]}
...
set Spec2ImplPortList { 
	layer32_out { ap_fifo {  { layer32_out_dout fifo_data_out 0 64 }  { layer32_out_empty_n fifo_status_empty 0 1 }  { layer32_out_read fifo_data_in 1 1 }  { layer32_out_num_data_valid fifo_update 0 9 }  { layer32_out_fifo_cap fifo_data 0 9 } } }
	layer9_out { ap_fifo {  { layer9_out_din fifo_data_out 1 96 }  { layer9_out_full_n fifo_status_empty 0 1 }  { layer9_out_write fifo_data_in 1 1 }  { layer9_out_num_data_valid fifo_update 0 2 }  { layer9_out_fifo_cap fifo_data 0 2 } } }
}
