...
set C_modelArgList {
	{ layer35_out int 128 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "layer35_out", "interface" : "fifo", "bitwidth" : 128, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ layer35_out_dout sc_in sc_lv 128 signal 0 } 
	{ layer35_out_empty_n sc_in sc_logic 1 signal 0 } 
	{ layer35_out_read sc_out sc_logic 1 signal 0 } 
	{ layer35_out_num_data_valid sc_in sc_lv 7 signal 0 } 
	{ layer35_out_fifo_cap sc_in sc_lv 7 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer35_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "layer35_out", "role": "dout" }} , 
 	...
 	{ "name": "layer35_out_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "layer35_out", "role": "num_data_valid" }} , 
 	{ "name": "layer35_out_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "layer35_out", "role": "fifo_cap" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "6938", "Max" : "6938"}
...
set Spec2ImplPortList { 
	layer35_out { ap_fifo {  { layer35_out_dout fifo_data_out 0 128 }  { layer35_out_empty_n fifo_status_empty 0 1 }  { layer35_out_read fifo_data_in 1 1 }  { layer35_out_num_data_valid fifo_update 0 7 }  { layer35_out_fifo_cap fifo_data 0 7 } } }
	layer19_out { ap_fifo {  { layer19_out_din fifo_data_out 1 128 }  { layer19_out_full_n fifo_status_empty 0 1 }  { layer19_out_write fifo_data_in 1 1 }  { layer19_out_num_data_valid fifo_update 0 2 }  { layer19_out_fifo_cap fifo_data 0 2 } } }
}
