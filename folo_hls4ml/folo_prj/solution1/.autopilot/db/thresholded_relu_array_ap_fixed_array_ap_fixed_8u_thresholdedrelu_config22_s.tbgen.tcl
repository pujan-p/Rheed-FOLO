...
set C_modelArgList {
	{ layer21_out int 224 regular {fifo 0 volatile }  }
	{ layer22_out int 80 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "layer21_out", "interface" : "fifo", "bitwidth" : 224, "direction" : "READONLY"} , 
 	{ "Name" : "layer22_out", "interface" : "fifo", "bitwidth" : 80, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer21_out_dout sc_in sc_lv 224 signal 0 } 
	...
	{ layer22_out_din sc_out sc_lv 80 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer21_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":224, "type": "signal", "bundle":{"name": "layer21_out", "role": "dout" }} , 
 	...
 	{ "name": "layer22_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":80, "type": "signal", "bundle":{"name": "layer22_out", "role": "din" }} , 
...
set Spec2ImplPortList { 
	layer21_out { ap_fifo {  { layer21_out_dout fifo_data_out 0 224 }  { layer21_out_empty_n fifo_status_empty 0 1 }  { layer21_out_read fifo_data_in 1 1 }  { layer21_out_num_data_valid fifo_update 0 3 }  { layer21_out_fifo_cap fifo_data 0 3 } } }
	layer22_out { ap_fifo {  { layer22_out_din fifo_data_out 1 80 }  { layer22_out_full_n fifo_status_empty 0 1 }  { layer22_out_write fifo_data_in 1 1 }  { layer22_out_num_data_valid fifo_update 0 32 }  { layer22_out_fifo_cap fifo_data 0 32 } } }
}
