...
set C_modelArgList {
	...
	{ layer22_out int 96 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "layer21_out", "interface" : "fifo", "bitwidth" : 96, "direction" : "READONLY"} , 
 	{ "Name" : "layer22_out", "interface" : "fifo", "bitwidth" : 96, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer21_out_num_data_valid sc_in sc_lv 11 signal 0 } 
	{ layer21_out_fifo_cap sc_in sc_lv 11 signal 0 } 
	{ layer21_out_empty_n sc_in sc_logic 1 signal 0 } 
	{ layer21_out_read sc_out sc_logic 1 signal 0 } 
	{ layer22_out_din sc_out sc_lv 96 signal 1 } 
	{ layer22_out_num_data_valid sc_in sc_lv 11 signal 1 } 
	{ layer22_out_fifo_cap sc_in sc_lv 11 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer22_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":96, "type": "signal", "bundle":{"name": "layer22_out", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "layer21_out", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "1024", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "layer21_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "layer22_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "1024", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	layer21_out { ap_fifo {  { layer21_out_dout fifo_data_in 0 96 }  { layer21_out_num_data_valid fifo_status_num_data_valid 0 11 }  { layer21_out_fifo_cap fifo_update 0 11 }  { layer21_out_empty_n fifo_status 0 1 }  { layer21_out_read fifo_port_we 1 1 } } }
	layer22_out { ap_fifo {  { layer22_out_din fifo_data_in 1 96 }  { layer22_out_num_data_valid fifo_status_num_data_valid 0 11 }  { layer22_out_fifo_cap fifo_update 0 11 }  { layer22_out_full_n fifo_status 0 1 }  { layer22_out_write fifo_port_we 1 1 } } }
}
