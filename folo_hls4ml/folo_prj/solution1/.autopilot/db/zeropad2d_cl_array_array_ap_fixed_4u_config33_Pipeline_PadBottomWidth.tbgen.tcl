set moduleName zeropad2d_cl_array_array_ap_fixed_4u_config33_Pipeline_PadBottomWidth
set isTopModule 0
...
set cdfgNum 64
set C_modelName {zeropad2d_cl<array,array<ap_fixed,4u>,config33>_Pipeline_PadBottomWidth}
