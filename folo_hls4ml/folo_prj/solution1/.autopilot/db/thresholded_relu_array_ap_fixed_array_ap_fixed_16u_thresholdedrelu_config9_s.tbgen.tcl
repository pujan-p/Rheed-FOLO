set moduleName thresholded_relu_array_ap_fixed_array_ap_fixed_16u_thresholdedrelu_config9_s
set isTopModule 0
...
set C_modelName {thresholded_relu<array,ap_fixed,array<ap_fixed,16u>,thresholdedrelu_config9>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer7_out int 656 regular {fifo 0 volatile }  }
	{ layer9_out int 256 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "layer7_out", "interface" : "fifo", "bitwidth" : 656, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ layer7_out_dout sc_in sc_lv 656 signal 0 } 
	{ layer7_out_num_data_valid sc_in sc_lv 13 signal 0 } 
	{ layer7_out_fifo_cap sc_in sc_lv 13 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer7_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":656, "type": "signal", "bundle":{"name": "layer7_out", "role": "dout" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "thresholded_relu_array_ap_fixed_array_ap_fixed_16u_thresholdedrelu_config9_s",
		"Protocol" : "ap_ctrl_hs",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "layer7_out", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "4096", "DependentChanType" : "0",
				"BlockSignal" : [
...
set ArgLastReadFirstWriteLatency {
	thresholded_relu_array_ap_fixed_array_ap_fixed_16u_thresholdedrelu_config9_s {
...
set Spec2ImplPortList { 
	layer7_out { ap_fifo {  { layer7_out_dout fifo_data_in 0 656 }  { layer7_out_num_data_valid fifo_status_num_data_valid 0 13 }  { layer7_out_fifo_cap fifo_update 0 13 }  { layer7_out_empty_n fifo_status 0 1 }  { layer7_out_read fifo_port_we 1 1 } } }
	layer9_out { ap_fifo {  { layer9_out_din fifo_data_in 1 256 }  { layer9_out_num_data_valid fifo_status_num_data_valid 0 13 }  { layer9_out_fifo_cap fifo_update 0 13 }  { layer9_out_full_n fifo_status 0 1 }  { layer9_out_write fifo_port_we 1 1 } } }
}
