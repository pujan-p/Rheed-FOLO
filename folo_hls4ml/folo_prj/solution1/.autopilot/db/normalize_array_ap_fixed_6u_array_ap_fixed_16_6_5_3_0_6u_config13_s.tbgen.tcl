set moduleName normalize_array_ap_fixed_6u_array_ap_fixed_16_6_5_3_0_6u_config13_s
set isTopModule 0
...
set cdfgNum 70
set C_modelName {normalize<array<ap_fixed,6u>,array<ap_fixed<16,6,5,3,0>,6u>,config13>}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ layer12_out int 96 regular {fifo 0 volatile }  }
	{ layer13_out int 96 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "layer12_out", "interface" : "fifo", "bitwidth" : 96, "direction" : "READONLY"} , 
 	{ "Name" : "layer13_out", "interface" : "fifo", "bitwidth" : 96, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer12_out_dout sc_in sc_lv 96 signal 0 } 
	...
	{ layer13_out_din sc_out sc_lv 96 signal 1 } 
	{ layer13_out_full_n sc_in sc_logic 1 signal 1 } 
	{ layer13_out_write sc_out sc_logic 1 signal 1 } 
	{ layer13_out_num_data_valid sc_in sc_lv 32 signal 1 } 
	{ layer13_out_fifo_cap sc_in sc_lv 32 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer13_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":96, "type": "signal", "bundle":{"name": "layer13_out", "role": "din" }} , 
 	...
 	{ "name": "layer13_out_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "layer13_out", "role": "num_data_valid" }} , 
 	{ "name": "layer13_out_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "layer13_out", "role": "fifo_cap" }}  ]}
...
set Spec2ImplPortList { 
	layer12_out { ap_fifo {  { layer12_out_dout fifo_data_out 0 96 }  { layer12_out_empty_n fifo_status_empty 0 1 }  { layer12_out_read fifo_data_in 1 1 }  { layer12_out_num_data_valid fifo_update 0 2 }  { layer12_out_fifo_cap fifo_data 0 2 } } }
	layer13_out { ap_fifo {  { layer13_out_din fifo_data_out 1 96 }  { layer13_out_full_n fifo_status_empty 0 1 }  { layer13_out_write fifo_data_in 1 1 }  { layer13_out_num_data_valid fifo_update 0 32 }  { layer13_out_fifo_cap fifo_data 0 32 } } }
}
