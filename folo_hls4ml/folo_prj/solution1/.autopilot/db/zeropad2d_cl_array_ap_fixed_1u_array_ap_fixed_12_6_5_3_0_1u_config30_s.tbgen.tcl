set moduleName zeropad2d_cl_array_ap_fixed_1u_array_ap_fixed_12_6_5_3_0_1u_config30_s
set isTopModule 0
...
set C_modelName {zeropad2d_cl<array<ap_fixed,1u>,array<ap_fixed<12,6,5,3,0>,1u>,config30>}
set C_modelType { void 0 }
set C_modelArgList {
	{ input_layer int 16 regular {axi_s 0 volatile  { input_layer Data } }  }
	{ layer30_out int 12 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "input_layer", "interface" : "axis", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "layer30_out", "interface" : "fifo", "bitwidth" : 12, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer30_out_din sc_out sc_lv 12 signal 1 } 
	{ layer30_out_num_data_valid sc_in sc_lv 18 signal 1 } 
	{ layer30_out_fifo_cap sc_in sc_lv 18 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer30_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "layer30_out", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "3", "5"],
		...
		"Port" : [
			{"Name" : "input_layer", "Type" : "Axis", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_zeropad2d_cl_array_array_ap_fixed_1u_config30_Pipeline_PadMain_CopyMain_fu_26", "Port" : "input_layer", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "layer30_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "66049", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_zeropad2d_cl_array_array_ap_fixed_1u_config30_Pipeline_PadMain_CopyMain_fu_26", "Port" : "layer30_out", "Inst_start_state" : "2", "Inst_end_state" : "3"},
					{"ID" : "3", "SubInstance" : "grp_zeropad2d_cl_array_array_ap_fixed_1u_config30_Pipeline_PadBottomWidth_fu_34", "Port" : "layer30_out", "Inst_start_state" : "5", "Inst_end_state" : "6"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_zeropad2d_cl_array_array_ap_fixed_1u_config30_Pipeline_PadMain_CopyMain_fu_26", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_zeropad2d_cl_array_array_ap_fixed_1u_config30_Pipeline_PadMain_CopyMain_fu_26.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_zeropad2d_cl_array_array_ap_fixed_1u_config30_Pipeline_PadBottomWidth_fu_34", "Parent" : "0", "Child" : ["4"],
	...
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_zeropad2d_cl_array_array_ap_fixed_1u_config30_Pipeline_PadBottomWidth_fu_34.flow_control_loop_pipe_sequential_init_U", "Parent" : "3"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_input_layer_U", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "131338", "Max" : "131338"}
	, {"Name" : "Interval", "Min" : "131338", "Max" : "131338"}
]}
...
set Spec2ImplPortList { 
	...
	layer30_out { ap_fifo {  { layer30_out_din fifo_data_in 1 12 }  { layer30_out_num_data_valid fifo_status_num_data_valid 0 18 }  { layer30_out_fifo_cap fifo_update 0 18 }  { layer30_out_full_n fifo_status 0 1 }  { layer30_out_write fifo_port_we 1 1 } } }
}
