set moduleName zeropad2d_cl_array_array_ap_fixed_6u_config33_Pipeline_PadBottomWidth
set isTopModule 0
...
set cdfgNum 72
set C_modelName {zeropad2d_cl<array,array<ap_fixed,6u>,config33>_Pipeline_PadBottomWidth}
