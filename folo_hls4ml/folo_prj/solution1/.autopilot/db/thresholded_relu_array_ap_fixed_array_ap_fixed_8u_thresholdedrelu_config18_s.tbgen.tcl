set moduleName thresholded_relu_array_ap_fixed_array_ap_fixed_8u_thresholdedrelu_config18_s
set isTopModule 0
...
set C_modelArgList {
	{ layer17_out int 96 regular {fifo 0 volatile }  }
	{ layer18_out int 96 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "layer17_out", "interface" : "fifo", "bitwidth" : 96, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ layer17_out_dout sc_in sc_lv 96 signal 0 } 
	{ layer17_out_num_data_valid sc_in sc_lv 11 signal 0 } 
	{ layer17_out_fifo_cap sc_in sc_lv 11 signal 0 } 
	...
	{ layer18_out_num_data_valid sc_in sc_lv 11 signal 1 } 
	{ layer18_out_fifo_cap sc_in sc_lv 11 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer17_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":96, "type": "signal", "bundle":{"name": "layer17_out", "role": "dout" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "layer17_out", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "1024", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "layer17_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "layer18_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "1024", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	layer17_out { ap_fifo {  { layer17_out_dout fifo_data_in 0 96 }  { layer17_out_num_data_valid fifo_status_num_data_valid 0 11 }  { layer17_out_fifo_cap fifo_update 0 11 }  { layer17_out_empty_n fifo_status 0 1 }  { layer17_out_read fifo_port_we 1 1 } } }
	layer18_out { ap_fifo {  { layer18_out_din fifo_data_in 1 96 }  { layer18_out_num_data_valid fifo_status_num_data_valid 0 11 }  { layer18_out_fifo_cap fifo_update 0 11 }  { layer18_out_full_n fifo_status 0 1 }  { layer18_out_write fifo_port_we 1 1 } } }
}
