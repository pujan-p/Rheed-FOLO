...
set C_modelArgList {
	{ layer30_out int 16 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "layer30_out", "interface" : "fifo", "bitwidth" : 16, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ layer30_out_dout sc_in sc_lv 16 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer30_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "layer30_out", "role": "dout" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "264199", "Max" : "264199"}
...
set Spec2ImplPortList { 
	layer30_out { ap_fifo {  { layer30_out_dout fifo_data_out 0 16 }  { layer30_out_empty_n fifo_status_empty 0 1 }  { layer30_out_read fifo_data_in 1 1 }  { layer30_out_num_data_valid fifo_update 0 18 }  { layer30_out_fifo_cap fifo_data 0 18 } } }
	layer2_out { ap_fifo {  { layer2_out_din fifo_data_out 1 64 }  { layer2_out_full_n fifo_status_empty 0 1 }  { layer2_out_write fifo_data_in 1 1 }  { layer2_out_num_data_valid fifo_update 0 2 }  { layer2_out_fifo_cap fifo_data 0 2 } } }
}
