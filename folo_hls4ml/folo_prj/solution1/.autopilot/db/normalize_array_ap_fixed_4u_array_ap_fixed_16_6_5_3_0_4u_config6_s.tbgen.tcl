set moduleName normalize_array_ap_fixed_4u_array_ap_fixed_16_6_5_3_0_4u_config6_s
set isTopModule 0
...
set cdfgNum 70
set C_modelName {normalize<array<ap_fixed,4u>,array<ap_fixed<16,6,5,3,0>,4u>,config6>}
...
set portList { 
	...
	{ layer6_out_num_data_valid sc_in sc_lv 32 signal 1 } 
	{ layer6_out_fifo_cap sc_in sc_lv 32 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer6_out_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "layer6_out", "role": "num_data_valid" }} , 
 	{ "name": "layer6_out_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "layer6_out", "role": "fifo_cap" }}  ]}
...
set Spec2ImplPortList { 
	layer5_out { ap_fifo {  { layer5_out_dout fifo_data_out 0 64 }  { layer5_out_empty_n fifo_status_empty 0 1 }  { layer5_out_read fifo_data_in 1 1 }  { layer5_out_num_data_valid fifo_update 0 2 }  { layer5_out_fifo_cap fifo_data 0 2 } } }
	layer6_out { ap_fifo {  { layer6_out_din fifo_data_out 1 64 }  { layer6_out_full_n fifo_status_empty 0 1 }  { layer6_out_write fifo_data_in 1 1 }  { layer6_out_num_data_valid fifo_update 0 32 }  { layer6_out_fifo_cap fifo_data 0 32 } } }
}
