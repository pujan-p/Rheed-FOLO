set moduleName normalize_array_ap_fixed_4u_array_ap_fixed_12_6_5_3_0_4u_config6_s
set isTopModule 0
...
set C_modelName {normalize<array<ap_fixed,4u>,array<ap_fixed<12,6,5,3,0>,4u>,config6>}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5"],
		...
		"Port" : [
			...
			{"Name" : "layer6_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "16384", "DependentChanType" : "0",
				"BlockSignal" : [
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_12s_11ns_18_1_1_U154", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_12s_11ns_18_1_1_U155", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_12s_12ns_18_1_1_U156", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_12s_11ns_18_1_1_U157", "Parent" : "0"},
...
set Spec2ImplPortList { 
	layer5_out { ap_fifo {  { layer5_out_dout fifo_data_in 0 48 }  { layer5_out_num_data_valid fifo_status_num_data_valid 0 15 }  { layer5_out_fifo_cap fifo_update 0 15 }  { layer5_out_empty_n fifo_status 0 1 }  { layer5_out_read fifo_port_we 1 1 } } }
	layer6_out { ap_fifo {  { layer6_out_din fifo_data_in 1 48 }  { layer6_out_num_data_valid fifo_status_num_data_valid 0 15 }  { layer6_out_fifo_cap fifo_update 0 15 }  { layer6_out_full_n fifo_status 0 1 }  { layer6_out_write fifo_port_we 1 1 } } }
}
