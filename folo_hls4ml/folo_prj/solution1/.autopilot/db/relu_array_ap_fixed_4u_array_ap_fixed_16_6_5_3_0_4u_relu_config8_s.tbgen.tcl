set moduleName relu_array_ap_fixed_4u_array_ap_fixed_16_6_5_3_0_4u_relu_config8_s
set isTopModule 0
...
set cdfgNum 64
set C_modelName {relu<array<ap_fixed,4u>,array<ap_fixed<16,6,5,3,0>,4u>,relu_config8>}
...
set portList { 
	...
	{ layer7_out_num_data_valid sc_in sc_lv 18 signal 0 } 
	{ layer7_out_fifo_cap sc_in sc_lv 18 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer7_out_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":18, "type": "signal", "bundle":{"name": "layer7_out", "role": "num_data_valid" }} , 
 	{ "name": "layer7_out_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":18, "type": "signal", "bundle":{"name": "layer7_out", "role": "fifo_cap" }} , 
...
set ArgLastReadFirstWriteLatency {
	relu_array_ap_fixed_4u_array_ap_fixed_16_6_5_3_0_4u_relu_config8_s {
...
set Spec2ImplPortList { 
	layer7_out { ap_fifo {  { layer7_out_dout fifo_data_out 0 64 }  { layer7_out_empty_n fifo_status_empty 0 1 }  { layer7_out_read fifo_data_in 1 1 }  { layer7_out_num_data_valid fifo_update 0 18 }  { layer7_out_fifo_cap fifo_data 0 18 } } }
	layer8_out { ap_fifo {  { layer8_out_din fifo_data_out 1 64 }  { layer8_out_full_n fifo_status_empty 0 1 }  { layer8_out_write fifo_data_in 1 1 }  { layer8_out_num_data_valid fifo_update 0 32 }  { layer8_out_fifo_cap fifo_data 0 32 } } }
}
