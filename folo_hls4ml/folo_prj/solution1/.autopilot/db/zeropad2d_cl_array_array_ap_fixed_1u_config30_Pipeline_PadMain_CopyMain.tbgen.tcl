set moduleName zeropad2d_cl_array_array_ap_fixed_1u_config30_Pipeline_PadMain_CopyMain
set isTopModule 0
...
set C_modelName {zeropad2d_cl<array,array<ap_fixed,1u>,config30>_Pipeline_PadMain_CopyMain}
...
set portList { 
	...
	{ layer30_out_din sc_out sc_lv 12 signal 0 } 
	...
	{ input_layer_TVALID sc_in sc_logic 1 invld 1 } 
	{ input_layer_TDATA sc_in sc_lv 16 signal 1 } 
	{ input_layer_TREADY sc_out sc_logic 1 inacc 1 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	...
	input_layer { axis {  { input_layer_TVALID in_vld 0 1 }  { input_layer_TDATA in_data 0 16 }  { input_layer_TREADY in_acc 1 1 } } }
}
