...
set C_modelArgList {
	{ layer31_out int 64 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "layer31_out", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ layer31_out_dout sc_in sc_lv 64 signal 0 } 
	{ layer31_out_empty_n sc_in sc_logic 1 signal 0 } 
	{ layer31_out_read sc_out sc_logic 1 signal 0 } 
	{ layer31_out_num_data_valid sc_in sc_lv 9 signal 0 } 
	{ layer31_out_fifo_cap sc_in sc_lv 9 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer31_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "layer31_out", "role": "dout" }} , 
 	...
 	{ "name": "layer31_out_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "layer31_out", "role": "num_data_valid" }} , 
 	{ "name": "layer31_out_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "layer31_out", "role": "fifo_cap" }} , 
...
set PerformanceInfo {[
	...
	, {"Name" : "Interval", "Min" : "101400", "Max" : "101400"}
]}
...
set Spec2ImplPortList { 
	layer31_out { ap_fifo {  { layer31_out_dout fifo_data_out 0 64 }  { layer31_out_empty_n fifo_status_empty 0 1 }  { layer31_out_read fifo_data_in 1 1 }  { layer31_out_num_data_valid fifo_update 0 9 }  { layer31_out_fifo_cap fifo_data 0 9 } } }
	layer5_out { ap_fifo {  { layer5_out_din fifo_data_out 1 64 }  { layer5_out_full_n fifo_status_empty 0 1 }  { layer5_out_write fifo_data_in 1 1 }  { layer5_out_num_data_valid fifo_update 0 2 }  { layer5_out_fifo_cap fifo_data 0 2 } } }
}
