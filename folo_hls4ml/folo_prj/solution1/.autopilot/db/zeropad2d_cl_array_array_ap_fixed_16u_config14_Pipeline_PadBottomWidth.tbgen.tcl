set moduleName zeropad2d_cl_array_array_ap_fixed_16u_config14_Pipeline_PadBottomWidth
set isTopModule 0
...
set C_modelName {zeropad2d_cl<array,array<ap_fixed,16u>,config14>_Pipeline_PadBottomWidth}
