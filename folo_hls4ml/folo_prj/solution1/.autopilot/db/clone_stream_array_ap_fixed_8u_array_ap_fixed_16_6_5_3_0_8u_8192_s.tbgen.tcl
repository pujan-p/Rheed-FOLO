...
set C_modelArgList {
	...
	{ layer29_cpy1 int 128 regular {fifo 1 volatile }  }
	{ layer29_cpy2 int 128 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "layer18_out", "interface" : "fifo", "bitwidth" : 128, "direction" : "READONLY"} , 
 	{ "Name" : "layer29_cpy1", "interface" : "fifo", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "layer29_cpy2", "interface" : "fifo", "bitwidth" : 128, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer29_cpy1_din sc_out sc_lv 128 signal 1 } 
	...
	{ layer29_cpy2_din sc_out sc_lv 128 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer29_cpy1_din", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "layer29_cpy1", "role": "din" }} , 
 	...
 	{ "name": "layer29_cpy2_din", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "layer29_cpy2", "role": "din" }} , 
...
set Spec2ImplPortList { 
	layer18_out { ap_fifo {  { layer18_out_dout fifo_data_out 0 128 }  { layer18_out_empty_n fifo_status_empty 0 1 }  { layer18_out_read fifo_data_in 1 1 }  { layer18_out_num_data_valid fifo_update 0 3 }  { layer18_out_fifo_cap fifo_data 0 3 } } }
	layer29_cpy1 { ap_fifo {  { layer29_cpy1_din fifo_data_out 1 128 }  { layer29_cpy1_full_n fifo_status_empty 0 1 }  { layer29_cpy1_write fifo_data_in 1 1 }  { layer29_cpy1_num_data_valid fifo_update 0 3 }  { layer29_cpy1_fifo_cap fifo_data 0 3 } } }
	layer29_cpy2 { ap_fifo {  { layer29_cpy2_din fifo_data_out 1 128 }  { layer29_cpy2_full_n fifo_status_empty 0 1 }  { layer29_cpy2_write fifo_data_in 1 1 }  { layer29_cpy2_num_data_valid fifo_update 0 7 }  { layer29_cpy2_fifo_cap fifo_data 0 7 } } }
}
