...
set Spec2ImplPortList { 
	...
	layer6_out { ap_fifo {  { layer6_out_dout fifo_data_out 0 64 }  { layer6_out_empty_n fifo_status_empty 0 1 }  { layer6_out_read fifo_data_in 1 1 }  { layer6_out_num_data_valid fifo_update 0 3 }  { layer6_out_fifo_cap fifo_data 0 3 } } }
