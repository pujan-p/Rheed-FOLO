set moduleName thresholded_relu_array_ap_fixed_array_ap_fixed_16u_thresholdedrelu_config5_s
set isTopModule 0
...
set C_modelName {thresholded_relu<array,ap_fixed,array<ap_fixed,16u>,thresholdedrelu_config5>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer3_out int 592 regular {fifo 0 volatile }  }
	{ layer5_out int 256 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "layer3_out", "interface" : "fifo", "bitwidth" : 592, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ layer3_out_dout sc_in sc_lv 592 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer3_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":592, "type": "signal", "bundle":{"name": "layer3_out", "role": "dout" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "thresholded_relu_array_ap_fixed_array_ap_fixed_16u_thresholdedrelu_config5_s",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	thresholded_relu_array_ap_fixed_array_ap_fixed_16u_thresholdedrelu_config5_s {
...
set Spec2ImplPortList { 
	layer3_out { ap_fifo {  { layer3_out_dout fifo_data_in 0 592 }  { layer3_out_num_data_valid fifo_status_num_data_valid 0 15 }  { layer3_out_fifo_cap fifo_update 0 15 }  { layer3_out_empty_n fifo_status 0 1 }  { layer3_out_read fifo_port_we 1 1 } } }
	layer5_out { ap_fifo {  { layer5_out_din fifo_data_in 1 256 }  { layer5_out_num_data_valid fifo_status_num_data_valid 0 15 }  { layer5_out_fifo_cap fifo_update 0 15 }  { layer5_out_full_n fifo_status 0 1 }  { layer5_out_write fifo_port_we 1 1 } } }
}
