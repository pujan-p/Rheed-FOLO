set moduleName zeropad2d_cl_array_ap_fixed_1u_array_ap_fixed_16_6_5_3_0_1u_config32_s
set isTopModule 0
...
set cdfgNum 64
set C_modelName {zeropad2d_cl<array<ap_fixed,1u>,array<ap_fixed<16,6,5,3,0>,1u>,config32>}
...
set ArgLastReadFirstWriteLatency {
	zeropad2d_cl_array_ap_fixed_1u_array_ap_fixed_16_6_5_3_0_1u_config32_s {
	...
	zeropad2d_cl_array_array_ap_fixed_16_6_5_3_0_1u_config32_Pipeline_CopyMain {
		input_2 {Type I LastRead 1 FirstWrite -1}
		layer32_out {Type O LastRead -1 FirstWrite 1}}
	zeropad2d_cl_array_array_ap_fixed_1u_config32_Pipeline_PadBottomWidth {
		layer32_out {Type O LastRead -1 FirstWrite 1}}}
...
set Spec2ImplPortList { 
	input_2 { axis {  { input_2_TDATA in_data 0 16 }  { input_2_TVALID in_vld 0 1 }  { input_2_TREADY in_acc 1 1 } } }
	layer32_out { ap_fifo {  { layer32_out_din fifo_data_out 1 16 }  { layer32_out_full_n fifo_status_empty 0 1 }  { layer32_out_write fifo_data_in 1 1 }  { layer32_out_num_data_valid fifo_update 0 32 }  { layer32_out_fifo_cap fifo_data 0 32 } } }
}
