...
// wrapc file define:
#define AUTOTB_TVIN_input_layer_1 "../tv/cdatafile/c.folo.autotvin_input_layer_1.dat"
#define WRAPC_STREAM_SIZE_IN_input_layer_1 "../tv/stream_size/stream_size_in_input_layer_1.dat"
#define WRAPC_STREAM_INGRESS_STATUS_input_layer_1 "../tv/stream_size/stream_ingress_status_input_layer_1.dat"
#define AUTOTB_TVOUT_layer26_out "../tv/cdatafile/c.folo.autotvout_layer26_out.dat"
#define WRAPC_STREAM_SIZE_OUT_layer26_out "../tv/stream_size/stream_size_out_layer26_out.dat"
#define WRAPC_STREAM_EGRESS_STATUS_layer26_out "../tv/stream_size/stream_egress_status_layer26_out.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_layer26_out "../tv/rtldatafile/rtl.folo.autotvout_layer26_out.dat"
...
extern "C"
void folo_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_folo_hw(void* __xlx_apatb_param_input_layer_1, void* __xlx_apatb_param_layer26_out)
{
  static hls::sim::Stream<hls::sim::Byte<2>> port0 {
    .width = 16,
    .name = "input_layer_1",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_input_layer_1),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_input_layer_1),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_input_layer_1),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_input_layer_1),
#endif
  };
  port0.param = (hls::stream<hls::sim::Byte<2>>*)__xlx_apatb_param_input_layer_1;
  ...
  static hls::sim::Stream<hls::sim::Byte<2>> port1 {
    ...
    .name = "layer26_out",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_layer26_out),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_layer26_out),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_layer26_out),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_EGRESS_STATUS_layer26_out),
#endif
  };
  port1.param = (hls::stream<hls::sim::Byte<2>>*)__xlx_apatb_param_layer26_out;
  port1.hasWrite = true;
  ...
  try {
    ...
    folo_hw_stub_wrapper(__xlx_apatb_param_input_layer_1, __xlx_apatb_param_layer26_out);
    port1.buffer();
