...
set C_modelArgList {
	{ layer25_out int 36 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "layer25_out", "interface" : "fifo", "bitwidth" : 36, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ layer25_out_dout sc_in sc_lv 36 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer25_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":36, "type": "signal", "bundle":{"name": "layer25_out", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	layer25_out { ap_fifo {  { layer25_out_dout fifo_data_out 0 36 }  { layer25_out_empty_n fifo_status_empty 0 1 }  { layer25_out_read fifo_data_in 1 1 }  { layer25_out_num_data_valid fifo_update 0 2 }  { layer25_out_fifo_cap fifo_data 0 2 } } }
