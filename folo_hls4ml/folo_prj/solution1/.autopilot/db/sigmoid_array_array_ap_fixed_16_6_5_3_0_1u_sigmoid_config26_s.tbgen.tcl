set moduleName sigmoid_array_array_ap_fixed_16_6_5_3_0_1u_sigmoid_config26_s
set isTopModule 0
...
set cdfgNum 70
set C_modelName {sigmoid<array,array<ap_fixed<16,6,5,3,0>,1u>,sigmoid_config26>}
...
set portList { 
	...
	{ layer25_out_num_data_valid sc_in sc_lv 3 signal 0 } 
	{ layer25_out_fifo_cap sc_in sc_lv 3 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer25_out_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "layer25_out", "role": "num_data_valid" }} , 
 	{ "name": "layer25_out_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "layer25_out", "role": "fifo_cap" }} , 
...
set Spec2ImplPortList { 
	layer25_out { ap_fifo {  { layer25_out_dout fifo_data_out 0 16 }  { layer25_out_empty_n fifo_status_empty 0 1 }  { layer25_out_read fifo_data_in 1 1 }  { layer25_out_num_data_valid fifo_update 0 3 }  { layer25_out_fifo_cap fifo_data 0 3 } } }
