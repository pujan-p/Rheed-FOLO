set moduleName thresholded_relu_array_ap_fixed_array_ap_fixed_4u_thresholdedrelu_config4_s
set isTopModule 0
...
set C_modelName {thresholded_relu<array,ap_fixed,array<ap_fixed,4u>,thresholdedrelu_config4>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer3_out int 48 regular {fifo 0 volatile }  }
	{ layer4_out int 48 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "layer3_out", "interface" : "fifo", "bitwidth" : 48, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ layer3_out_dout sc_in sc_lv 48 signal 0 } 
	{ layer3_out_num_data_valid sc_in sc_lv 15 signal 0 } 
	{ layer3_out_fifo_cap sc_in sc_lv 15 signal 0 } 
	...
	{ layer4_out_num_data_valid sc_in sc_lv 15 signal 1 } 
	{ layer4_out_fifo_cap sc_in sc_lv 15 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer3_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":48, "type": "signal", "bundle":{"name": "layer3_out", "role": "dout" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "layer3_out", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "16384", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "layer3_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "layer4_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "16384", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	layer3_out { ap_fifo {  { layer3_out_dout fifo_data_in 0 48 }  { layer3_out_num_data_valid fifo_status_num_data_valid 0 15 }  { layer3_out_fifo_cap fifo_update 0 15 }  { layer3_out_empty_n fifo_status 0 1 }  { layer3_out_read fifo_port_we 1 1 } } }
	layer4_out { ap_fifo {  { layer4_out_din fifo_data_in 1 48 }  { layer4_out_num_data_valid fifo_status_num_data_valid 0 15 }  { layer4_out_fifo_cap fifo_update 0 15 }  { layer4_out_full_n fifo_status 0 1 }  { layer4_out_write fifo_port_we 1 1 } } }
}
