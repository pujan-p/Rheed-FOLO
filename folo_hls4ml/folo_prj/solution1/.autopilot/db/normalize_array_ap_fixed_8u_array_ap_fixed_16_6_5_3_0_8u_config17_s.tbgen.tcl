set moduleName normalize_array_ap_fixed_8u_array_ap_fixed_16_6_5_3_0_8u_config17_s
set isTopModule 0
...
set cdfgNum 70
set C_modelName {normalize<array<ap_fixed,8u>,array<ap_fixed<16,6,5,3,0>,8u>,config17>}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ layer16_out int 128 regular {fifo 0 volatile }  }
	{ layer17_out int 128 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "layer16_out", "interface" : "fifo", "bitwidth" : 128, "direction" : "READONLY"} , 
 	{ "Name" : "layer17_out", "interface" : "fifo", "bitwidth" : 128, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer17_out_din sc_out sc_lv 128 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer17_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "layer17_out", "role": "din" }} , 
...
set Spec2ImplPortList { 
	layer16_out { ap_fifo {  { layer16_out_dout fifo_data_out 0 128 }  { layer16_out_empty_n fifo_status_empty 0 1 }  { layer16_out_read fifo_data_in 1 1 }  { layer16_out_num_data_valid fifo_update 0 2 }  { layer16_out_fifo_cap fifo_data 0 2 } } }
	layer17_out { ap_fifo {  { layer17_out_din fifo_data_out 1 128 }  { layer17_out_full_n fifo_status_empty 0 1 }  { layer17_out_write fifo_data_in 1 1 }  { layer17_out_num_data_valid fifo_update 0 32 }  { layer17_out_fifo_cap fifo_data 0 32 } } }
}
