set moduleName zeropad2d_cl_array_array_ap_fixed_8u_config37_Pipeline_PadBottomWidth
set isTopModule 0
...
set cdfgNum 64
set C_modelName {zeropad2d_cl<array,array<ap_fixed,8u>,config37>_Pipeline_PadBottomWidth}
