set moduleName pointwise_conv_2d_cl_array_array_ap_fixed_36_16_5_3_0_1u_config37_s
set isTopModule 0
...
set cdfgNum 72
set C_modelName {pointwise_conv_2d_cl<array,array<ap_fixed<36,16,5,3,0>,1u>,config37>}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ layer24_out int 128 regular {fifo 0 volatile }  }
	{ layer25_out int 36 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "layer24_out", "interface" : "fifo", "bitwidth" : 128, "direction" : "READONLY"} , 
 	{ "Name" : "layer25_out", "interface" : "fifo", "bitwidth" : 36, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer25_out_din sc_out sc_lv 36 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer25_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":36, "type": "signal", "bundle":{"name": "layer25_out", "role": "din" }} , 
...
set ArgLastReadFirstWriteLatency {
	pointwise_conv_2d_cl_array_array_ap_fixed_36_16_5_3_0_1u_config37_s {
		layer24_out {Type I LastRead 0 FirstWrite -1}
		layer25_out {Type O LastRead -1 FirstWrite 9}}
...
set Spec2ImplPortList { 
	...
	layer25_out { ap_fifo {  { layer25_out_din fifo_data_out 1 36 }  { layer25_out_full_n fifo_status_empty 0 1 }  { layer25_out_write fifo_data_in 1 1 }  { layer25_out_num_data_valid fifo_update 0 2 }  { layer25_out_fifo_cap fifo_data 0 2 } } }
}
