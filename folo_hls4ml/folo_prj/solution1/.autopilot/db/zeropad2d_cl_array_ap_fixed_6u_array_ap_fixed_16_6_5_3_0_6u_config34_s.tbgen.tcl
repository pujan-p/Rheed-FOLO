set moduleName zeropad2d_cl_array_ap_fixed_6u_array_ap_fixed_16_6_5_3_0_6u_config34_s
set isTopModule 0
...
set cdfgNum 70
set C_modelName {zeropad2d_cl<array<ap_fixed,6u>,array<ap_fixed<16,6,5,3,0>,6u>,config34>}
...
set portList { 
	...
	{ layer34_out_din sc_out sc_lv 96 signal 1 } 
...
set Spec2ImplPortList { 
	layer15_out { ap_fifo {  { layer15_out_dout fifo_data_out 0 96 }  { layer15_out_empty_n fifo_status_empty 0 1 }  { layer15_out_read fifo_data_in 1 1 }  { layer15_out_num_data_valid fifo_update 0 3 }  { layer15_out_fifo_cap fifo_data 0 3 } } }
