set moduleName normalize_array_ap_fixed_8u_array_ap_fixed_16_6_5_3_0_8u_config20_s
set isTopModule 0
...
set cdfgNum 70
set C_modelName {normalize<array<ap_fixed,8u>,array<ap_fixed<16,6,5,3,0>,8u>,config20>}
...
set portList { 
	...
	{ layer19_out_dout sc_in sc_lv 128 signal 0 } 
...
set Spec2ImplPortList { 
	layer19_out { ap_fifo {  { layer19_out_dout fifo_data_out 0 128 }  { layer19_out_empty_n fifo_status_empty 0 1 }  { layer19_out_read fifo_data_in 1 1 }  { layer19_out_num_data_valid fifo_update 0 2 }  { layer19_out_fifo_cap fifo_data 0 2 } } }
	layer20_out { ap_fifo {  { layer20_out_din fifo_data_out 1 128 }  { layer20_out_full_n fifo_status_empty 0 1 }  { layer20_out_write fifo_data_in 1 1 }  { layer20_out_num_data_valid fifo_update 0 32 }  { layer20_out_fifo_cap fifo_data 0 32 } } }
}
