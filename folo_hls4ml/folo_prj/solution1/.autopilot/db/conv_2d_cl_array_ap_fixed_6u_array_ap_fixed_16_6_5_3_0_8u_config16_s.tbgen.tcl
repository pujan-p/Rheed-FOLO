...
set C_modelArgList {
	{ layer34_out int 96 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "layer34_out", "interface" : "fifo", "bitwidth" : 96, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ layer34_out_dout sc_in sc_lv 96 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer34_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":96, "type": "signal", "bundle":{"name": "layer34_out", "role": "dout" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "25353", "Max" : "25353"}
	, {"Name" : "Interval", "Min" : "25350", "Max" : "25350"}
]}
...
set Spec2ImplPortList { 
	layer34_out { ap_fifo {  { layer34_out_dout fifo_data_out 0 96 }  { layer34_out_empty_n fifo_status_empty 0 1 }  { layer34_out_read fifo_data_in 1 1 }  { layer34_out_num_data_valid fifo_update 0 7 }  { layer34_out_fifo_cap fifo_data 0 7 } } }
