...
# 
# ==============================================================
set ::env(LD_LIBRARY_PATH) /home/tools/Xilinx/2025/2025.2/Vitis/lnx64/tools/fpo_v7_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/tools/Xilinx/2025/2025.2/Vitis/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/tools/Xilinx/2025/2025.2/Vitis/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/tools/Xilinx/2025/2025.2/Vitis/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/tools/Xilinx/2025/2025.2/Vitis/tps/lnx64/gcc-8.3.0/lib:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/tools/Xilinx/2025/2025.2/Vitis/lib/lnx64.o/Ubuntu:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "folo.autotvin.dat"
	set constFileTvOut       "folo.autotvout.dat"
	set constFileHdlTvIn     "folo.autohdltvin.dat"
	set constFileHdlTvOut    "folo.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
