...
// wrapc file define:
#define AUTOTB_TVIN_input_2 "../tv/cdatafile/c.folo.autotvin_input_2.dat"
...
#define AUTOTB_TVOUT_layer28_out "../tv/cdatafile/c.folo.autotvout_layer28_out.dat"
#define WRAPC_STREAM_SIZE_OUT_layer28_out "../tv/stream_size/stream_size_out_layer28_out.dat"
#define WRAPC_STREAM_EGRESS_STATUS_layer28_out "../tv/stream_size/stream_egress_status_layer28_out.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_layer28_out "../tv/rtldatafile/rtl.folo.autotvout_layer28_out.dat"
...
extern "C"
void apatb_folo_hw(void* __xlx_apatb_param_input_2, void* __xlx_apatb_param_layer28_out)
{
  ...
  port0.param = (hls::stream<hls::sim::Byte<2>>*)__xlx_apatb_param_input_2;
  ...
  static hls::sim::Stream<hls::sim::Byte<2>> port1 {
    ...
    .name = "layer28_out",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_layer28_out),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_layer28_out),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_layer28_out),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_EGRESS_STATUS_layer28_out),
#endif
  };
  port1.param = (hls::stream<hls::sim::Byte<2>>*)__xlx_apatb_param_layer28_out;
  port1.hasWrite = true;
  ...
  try {
    ...
    folo_hw_stub_wrapper(__xlx_apatb_param_input_2, __xlx_apatb_param_layer28_out);
    port1.buffer();
