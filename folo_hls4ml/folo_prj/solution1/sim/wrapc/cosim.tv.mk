...
AUTOPILOT_ROOT := /home/tools/Xilinx/2025/2025.2/Vitis
...
IFLAG += -fPIC
ifndef AP_GCC_PATH
  AP_GCC_PATH := /home/tools/Xilinx/2025/2025.2/Vitis/tps/lnx64/gcc-8.3.0/bin
endif
AUTOPILOT_TOOL = ${AUTOPILOT_ROOT}/${AUTOPILOT_MACH}/tools
AUTOPILOT_TECH = ${AUTOPILOT_ROOT}/common/technology
AP_CLANG_PATH := ${AUTOPILOT_ROOT}/lnx64/tools/clang-16/bin
TOOLCHAIN += --gcc-toolchain=/home/tools/Xilinx/2025/2025.2/Vitis/tps/lnx64/gcc-8.3.0
LFLAG += --gcc-toolchain=/home/tools/Xilinx/2025/2025.2/Vitis/tps/lnx64/gcc-8.3.0
...
$(ObjDir)/folo_test.cpp_pre.cpp.tb.o : folo_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling folo_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++17 -fno-builtin-isinf -fno-builtin-isnan -c -std=c++0x -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/folo.cpp_pre.cpp.tb.o : folo.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling folo.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++17 -fno-builtin-isinf -fno-builtin-isnan -c -std=c++0x $(IFLAG) $(DFLAG) $< -o $@; \
