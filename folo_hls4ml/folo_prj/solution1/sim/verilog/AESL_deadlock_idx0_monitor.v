...
module AESL_deadlock_idx0_monitor ( // for module AESL_inst_folo
    input wire clock,
    input wire reset,
    input wire [1:0] axis_block_sigs,
    input wire [31:0] inst_idle_sigs,
...
wire idx1_block;
wire idx3_block;
wire [27:0] process_idle_vec;
wire [27:0] process_chan_block_vec;
wire [27:0] process_axis_block_vec;
...
assign process_axis_block_vec[27] = idx3_block & (1'b0 | axis_block_sigs[1]);
