...
void folo(
    ...
    #pragma HLS STREAM variable=layer27_cpy1 depth=33

    hls::stream<layer4_t> layer27_cpy2("layer27_cpy2");
    #pragma HLS STREAM variable=layer27_cpy2 depth=170

    hls::stream<layer31_t> layer31_out("layer31_out");
    #pragma HLS STREAM variable=layer31_out depth=250
    ...
    #pragma HLS STREAM variable=layer8_out depth=22

    hls::stream<layer32_t> layer32_out("layer32_out");
    #pragma HLS STREAM variable=layer32_out depth=131
    ...
    #pragma HLS STREAM variable=layer28_cpy1 depth=8

    hls::stream<layer11_t> layer28_cpy2("layer28_cpy2");
    #pragma HLS STREAM variable=layer28_cpy2 depth=73

    hls::stream<layer33_t> layer33_out("layer33_out");
    #pragma HLS STREAM variable=layer33_out depth=119
    ...
    #pragma HLS STREAM variable=layer15_out depth=4

    hls::stream<layer34_t> layer34_out("layer34_out");
    #pragma HLS STREAM variable=layer34_out depth=60
    ...
    #pragma HLS STREAM variable=layer29_cpy2 depth=40

    hls::stream<layer35_t> layer35_out("layer35_out");
    #pragma HLS STREAM variable=layer35_out depth=60
    ...
    #pragma HLS STREAM variable=layer20_out depth=2
    ...
    nnet::normalize<layer2_t, layer3_t, config3>(layer2_out, layer3_out, s3, b3); // b_1_1
    ...
    nnet::normalize<layer5_t, layer6_t, config6>(layer5_out, layer6_out, s6, b6); // b_1_2
    ...
    nnet::normalize<layer9_t, layer10_t, config10>(layer9_out, layer10_out, s10, b10); // b_2_1
    ...
    nnet::normalize<layer12_t, layer13_t, config13>(layer12_out, layer13_out, s13, b13); // b_2_2
    ...
    nnet::normalize<layer16_t, layer17_t, config17>(layer16_out, layer17_out, s17, b17); // b_3_1
    ...
    nnet::normalize<layer19_t, layer20_t, config20>(layer19_out, layer20_out, s20, b20); // b_3_2
    ...
    nnet::pointwise_conv_2d_cl<layer22_t, layer23_t, config36>(layer22_out, layer23_out, w23, b23); // conv2d_4

    nnet::relu<layer23_t, layer24_t, relu_config24>(layer23_out, layer24_out); // conv2d_4_relu

    nnet::pointwise_conv_2d_cl<layer24_t, layer25_t, config37>(layer24_out, layer25_out, w25, b25); // conv2d_5

    nnet::sigmoid<layer25_t, result_t, sigmoid_config26>(layer25_out, layer26_out); // conv2d_5_sigmoid
